...
public class SportCenter
{
  ...
  public Session addSession(int aId, int aLength, Time aStartTime, Time aEndTime, String aDayOfWeek, boolean aIsRepeating, ClassType aClassType, Instructor aInstructor)
  {
    return new Session(aId, aLength, aStartTime, aEndTime, aDayOfWeek, aIsRepeating, aClassType, aInstructor, this);
  }
